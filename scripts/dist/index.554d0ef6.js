...
})({"4h6sB":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "bb58928b554d0ef6";
"use strict";
...
},{}],"gP86n":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "score", ()=>score);
var _scoreAPIJs = require("./scoreAPI.js");
var _scoreAPIJsDefault = parcelHelpers.interopDefault(_scoreAPIJs);
feather.replace();
...
function handleTypingEvents(letterContainers, event) {
    ...
    if (currentLetterIndex >= letterContainers.length) {
        ...
        calculateScore();
        console.log(score);
        (0, _scoreAPIJsDefault.default).postScore(score);
    ...
    if (letterContainers[currentLetterIndex].textContent === key) {
        ...
        currentLetterIndex++;
        if (currentLetterIndex < letterContainers.length) letterContainers[currentLetterIndex].classList.add(current);
...
function calculateScore() {
    const timeTaken = (times.endTime - times.startTime) / 60000;
...
},{"./scoreAPI.js":"gwyUh","@parcel/transformer-js/src/esmodule-helpers.js":"gdRI1"}],"gwyUh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class scoreAPI {
...
exports.default = scoreAPI;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gdRI1"}],"gdRI1":[function(require,module,exports) {
...
},{}]},["4h6sB","gP86n"], "gP86n", "parcelRequire94c2")

//# sourceMappingURL=index.554d0ef6.js.map
